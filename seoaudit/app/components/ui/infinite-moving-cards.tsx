                ...
                {items.map((item, idx) => (
                    ...
                    >
                        <blockquote>
                            ...
                            ></div>
                            <div className=" relative z-20 text-lg text-[#3679FD] font-bold text-center uppercase">
                                {item.quote}
                            ...
                            <div className="relative z-20 flex flex-row items-center">
                                <div className="flex flex-col gap-1">
                                    <div className=" text-sm leading-[1.6] text-center text-gray-400 font-normal">
                                        {item.name}
                                    </div>
