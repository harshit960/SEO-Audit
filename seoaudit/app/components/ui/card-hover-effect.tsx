      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full border-transparent bg-neutral-200 dark:bg-slate-800/[0.8] block  rounded-3xl"
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-zinc-00 font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
