    ...
    <>
      <div className="py-20 bg-[#F8D57E] flex flex-col items-center justify-center mt-20">
        ...
        <div className="flex mt-14 justify-center w-full flex-wrap items-center">
          <div className="w-[570px]  bg-white rounded p-10 pt-6 m-5  h-[280px]">
            <div className="flex flex-wrap lg:flex-nowrap justify-center items-center">
              <div className="flex flex-col grow items-center justify-center w-36 ">
                ...
                <div className="text-base whitespace- text-center">{reviews && reviews[0]?.userRole}</div>
              </div>
              <div className="flex w-[470px] flex-col py-2 lg:pl-10 text-center lg:text-left">
                <div>
                ...
                <div className="text-base line-clamp-5 text-justify">
          ...
          <div className="w-[570px]  bg-white rounded p-10 pt-6 m-5 h-[280px]">
            <div className="flex flex-wrap lg:flex-nowrap justify-center">
              <div className="flex flex-col items-center justify-center w-36">
                ...
                <div className="text-base whitespace text-center ">{reviews && reviews[1]?.userRole}</div>
              </div>
              <div className="flex w-[470px] flex-col p-2 lg:pl-10 text-center lg:text-left">
                <div className="rating rating-md mb-4 rating-half">
                  {/* <input type="radio" name="rating-10" className="rating-hidden" /> */}
                  <input type="radio" name="rating-10" className="mask mask-star-2 mask-half-1 bg-orange-400" />
                  <input type="radio" name="rating-10" className="mask mask-star-2 mask-half-2 bg-orange-400" />
