...
function Contactus() {
    ...
    const handleSubmit = () => {
        ...
        const formData = {
            name: fullName,
            email: email,
            message: message // Add the message value here
        };
    ...
    return (
        <>
            <div className="flex flex-col w-full my-5 lg:pr-40">
                ...
                />
                <div
                    className="text-white cursor-pointer my-2 lg:m-2 hover:bg-[#2D2D2D] duration-200 bg-[#009379] w-32 p-2 rounded-xl text-center font-semibold"
