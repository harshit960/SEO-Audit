...
async function YourComponent() {
    ...
    return (
        <Suspense fallback={<div>Loading...</div>}>
            <div className="md:hidden fixed lg:block flex flex-col top-0 left-0 min-w-80 bg-[#F8F9FF] h-full border-r">
            ...
            <div className="flex">
                <div className="h-screen min-w-80 md:hidden lg:block">
                </div>
                <div className=' flex grow  flex-col items-center justify-center bg-[#c9d2fc55] text-[#2D2D2D] ' >
                    ...
                    <div className="flex w-4/5 justify-between mt-10">

                        <div className=" flex justify-between mr-2 bg-white p-10 rounded-lg grow">

                        </div>
                        <div className=" flex justify-between mx-2 bg-white p-10 rounded-lg grow">

                        </div>
                        <div className=" flex justify-between ml-2 bg-white p-10 rounded-lg grow">
