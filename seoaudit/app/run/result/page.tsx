...
async function YourComponent() {
    ...
    useEffect(() => {
        ...
        setSocialMedia(performSocialMediaTest(psiData,appendToFailed,appendToSuccess))
        setSEOFriendlyUrl(extractSEOFriendlyUrlData(psiData,appendToFailed,appendToSuccess))
        setImageAltData(extractImageAltTestData(psiData,appendToFailed,appendToSuccess))
        setResponsiveImgData(extractResponsiveImageData(psiData,appendToFailed,appendToSuccess))
        setImageAspectRatioData(extractImageAspectRatioData(psiData,appendToFailed,appendToSuccess))
        setInlineCssData(extractInlineCssData(psiData,appendToFailed,appendToSuccess))
        setDeprecatedHtmlTagsData(extractDeprecatedHtmlTagsData(psiData,appendToFailed,appendToSuccess))
        setGoogleAnalyticsData(performGoogleAnalyticsTest(psiData,appendToFailed,appendToSuccess))
        setFaviconData(performFaviconTest(psiData,appendToFailed,appendToSuccess))
        setBacklinksData(performBacklinksTest(psiData,appendToFailed,appendToSuccess))
        setJSErrorData(performJSErrorTest(psiData,appendToFailed,appendToSuccess))
        setConsoleErrorsData(performConsoleErrorsTest(psiData,appendToFailed,appendToSuccess))
        setCharsetDeclarationData(performCharsetDeclarationTest(psiData,appendToFailed,appendToSuccess))
        setHTMLPageSizeData(performHTMLPageSizeTest(psiData,appendToFailed,appendToSuccess))
        setDOMSizeData(performDOMSizeTest(psiData,appendToFailed,appendToSuccess))
        setHTMLCompressionData(performHTMLCompressionTest(psiData,appendToFailed,appendToSuccess))
        setSiteLoadingSpeedData(performSiteLoadingSpeedTest(psiData,appendToFailed,appendToSuccess))
        setJSExecutionTimeData(performJSExecutionTimeTest(psiData,appendToFailed,appendToSuccess))
        setPageObjectsData(performPageObjectsTest(psiData,appendToFailed,appendToSuccess))
        setPageCacheData(performPageCacheTest(psiData,appendToFailed,appendToSuccess))
        setFlashData(performFlashTest(psiData,appendToFailed,appendToSuccess))
        setCDNUsageData(performCDNUsageTest(psiData,appendToFailed,appendToSuccess))
        setRenderBlockingResourcesData(performRenderBlockingResourcesTest(psiData,appendToFailed,appendToSuccess))
        setUrlRedirectsTest(performUrlRedirectsTest(psiData,appendToFailed,appendToSuccess))
        setFirstContentfulPaintTest(performFirstContentfulPaintTest(psiData,appendToFailed,appendToSuccess))
        setLargestContentfulPaintTest(performLargestContentfulPaintTest(psiData,appendToFailed,appendToSuccess))
        setCumulativeLayoutShiftTest(performCumulativeLayoutShiftTest(psiData,appendToFailed,appendToSuccess))
        setHttp2Test(performHttp2Test(psiData,appendToFailed,appendToSuccess))
        setHstsTest(performHstsTest(psiData,appendToFailed,appendToSuccess))
        setServerSignatureTest(performServerSignatureTest(psiData,appendToFailed,appendToSuccess))
        setMetaViewport(performMetaViewportTest(psiData,appendToFailed,appendToSuccess))
        setMediaQuery(performMediaQueryResponsiveTest(psiData,appendToFailed,appendToSuccess))
        setMobileSnapshot(performMobileSnapshotTest(psiData,appendToFailed,appendToSuccess))
        setStructuredData(performStructuredDataTest(psiData,appendToFailed,appendToSuccess))
        setNoindexTag(performNoindexTagTest(psiData,appendToFailed,appendToSuccess))
    }, [psiData]);
    useEffect(() => {
