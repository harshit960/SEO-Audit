...
export function extractInlineCssData(data: PSIData): { TotalCssResources: number; TotalCssBytes: number; TotalCssKb: number; Importance: string; Description: string; Link: string } {
