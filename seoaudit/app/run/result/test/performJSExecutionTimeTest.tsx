...
export function performJSExecutionTimeTest(data: any,appendToSuccess:any,appendToFailed:any): { BootupTime: number; ScriptBootUpTime: number; Importance: string; Description: string; Link: string } {
