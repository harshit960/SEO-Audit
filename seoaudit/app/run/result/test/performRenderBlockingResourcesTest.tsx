...
export function performRenderBlockingResourcesTest(data: PSIData): { HasRenderBlockingResources: boolean; Importance: string; Description: string; Link: string } {
    ...
    const jsRequests = networkRequestsAudit.details.items.filter(item => item.mimeType === 'application/javascript');
